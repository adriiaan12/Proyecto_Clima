...
# === 5. Escalar features numéricas (opcional, NB no lo necesita estrictamente) ===
...
# === 8. Crear y entrenar Gaussian Naive Bayes ===
nb_model = GaussianNB()
...
# === 10. Guardar modelo ===
joblib.dump(nb_model, "../models/nb_model.save")
print("✅ Naive Bayes guardado en /models/nb_model.save")
